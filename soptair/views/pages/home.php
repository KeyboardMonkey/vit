		...
		<section class="top-students">
			...
			<section class="first-trophy">
				<section class="content">
					<img src="<?=base_url();?>graphics/trophy1.svg" width="100px" height="111px" />
			...
			<section class="second-trophy">
				<section class="content">
					<img src="<?=base_url();?>graphics/trophy2.svg" width="100px" height="111px" />
			...
			<section class="third-trophy">
				<section class="content">
					<img src="<?=base_url();?>graphics/trophy3.svg" width="100px" height="111px" />
