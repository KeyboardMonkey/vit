<section class="container">
	<section class="content-md">
		...
		<section class="course-cols">
			<section class="col1">
				<ul class="cols">
					<li class="html"><strong>1,641</strong><br/>HTML</li>
					<li class="php"><strong>937</strong><br/>PHP</li>
					<li class="asp"><strong>831</strong><br/>ASP.Net</li>
					<li class="java"><strong>0</strong><br/>Java</li>
				</ul>
			</section>
			<section class="col2">
				<ul class="cols">
